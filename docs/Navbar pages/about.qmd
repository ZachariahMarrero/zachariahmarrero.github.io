...
The next post I will make, will cover a 'general-purpose' pipeline for running the [XGBoost](https://arxiv.org/pdf/1603.02754.pdf) algorithm (a personal favorite).  XGBoost is an extremely value tool to have in your analysis toolkit for multiple reasons.  
